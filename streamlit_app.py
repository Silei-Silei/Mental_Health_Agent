...
def main():
    st.set_page_config(
        page_title="Mental Health Agent",
        page_icon="🧠",
        layout="wide"
    )
    ...
    # Main tabs
    tab1, tab2, tab3, tab4, tab5 = st.tabs(["💬 Chat", "📊 Daily Check-in", "📈 Evaluation", "🎯 Recommendations", "⏰ Companion"])
    ...
    st.markdown("💡 **Tip**: This is a demo version. For production use, please deploy your own instance.")
