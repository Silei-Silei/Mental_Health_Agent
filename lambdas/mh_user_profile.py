    ...
    try:
        if action == "get_profile":
            ...
            return {
                ...
                "headers": {"Content-Type": "application/json"},
                "body": json.dumps(
                    {"user_id": user_id, "message": "Profile updated from chat data"}
                ),
            }
            ...
            return {
                ...
                "headers": {"Content-Type": "application/json"},
                "body": json.dumps(
                    {"user_id": user_id, "message": "Demographics updated successfully"}
                ),
            }
        ...
        return {
            ...
            "headers": {"Content-Type": "application/json"},
            "body": json.dumps(
                {"error": "Profile operation failed", "details": str(e)}
            ),
        }
...
if __name__ == "__main__":
    ...
    test_event = {
        "body": json.dumps({"user_id": "test_user_profile", "action": "get_profile"})
    }
